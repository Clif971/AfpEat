...
namespace AfpEat.Controllers
{
    public class MenusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdMenu,Nom,Statut,Prix")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdMenu,Nom,Statut,Prix")] Menu menu)
        {
            if (ModelState.IsValid)
            {
